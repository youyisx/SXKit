...
Pod::Spec.new do |s|
  ...
  #  s.source_files = 'SXBaseKit/Classes/SXLogger/**/*'
  #   s.resource_bundles = {
  ...
  s.subspec 'SXLogger' do |ss|
    ss.source_files = 'SXBaseKit/Classes/SXLogger/**/*'
  end
